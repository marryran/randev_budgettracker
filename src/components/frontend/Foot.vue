    ...
    <footer class="text-white bg-gray-900">
        <div class="container pt-10 mx-auto">
            <div class="flex flex-wrap">
                <div class="w-full p-4 xl:mr-auto xl:w-4/12 ml-10">
                    <!-- <img src="@/assets/img/logo-main.webp" class="w-48 mb-6" alt="smart logo" width="192" height="83"/> -->
                    <p class="mb-4 text-sm">Contact via <br>
                        phone : +66 93-131-7520 <br>
                        mail : marryrcp@gmail.com
                    </p>
                    <!-- <div class="mb-4">
                    ...
                    <!-- <div class="bg-white">
                        <a href="#facebook" title="facebook" class="mr-2 text-xl hover:text-indigo-200"><i class="far fa-facebook "></i></a>
                ...
                <div class="w-full p-4 xl:w-2/12 sm:w-4/12">
                    ...
                    <ul>
                        ...
                        <li class="mb-4">
                            <a href="/income" class="hover:text-indigo-200">Income</a>
                        </li>
                        <li class="mb-4">
                            <a href="/expense" class="hover:text-indigo-200">Expense</a>
                        </li>
                        <li class="mb-4">
                            <a href="/savings" class="hover:text-indigo-200">Savings</a>
                        </li>
                    </ul>
                </div>
                <!-- <div class="w-full p-4 xl:w-2/12 sm:w-4/12">
            ...
            <div class="p-4 text-center">
                ...
                <p class="text-sm">Copyright © 2023 Randev</p>
            </div>
        </div> 
    </footer>
</template>
