<template>
    <!-- Header -->
    <header class="fixed w-full bg-white z-10" x-data="{menuOpen: false}">
        
        <nav class="container flex flex-wrap items-center px-4 mx-auto shadow-md">
            <router-link to="/">
              <img src="@/assets/img/logo_new_full.png" alt="logo" class="w-30 p-3" width="160" height="69" />
            </router-link>
            ...
            <div class="hidden w-full ml-auto lg:block lg:w-auto">
                ...
                <router-link to="/income" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">
                  Income
                </router-link>

                <router-link to="/expense" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">
                  Expense
                </router-link>

                <router-link to="/savings" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">
                  Savings
                </router-link>

                <router-link to="/contact" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">
                  Contact
                </router-link>

                <!-- <router-link to="/register" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">
                  สมัครสมาชิก
                </router-link> -->
<!-- 
                <div class="inline-block px-4 py-2">
                  <router-link to="/login" class="inline-block px-6 py-2 text-white bg-indigo-600 border-2 border-indigo-600 rounded-md hover:text-indigo-600 hover:bg-indigo-100">
                    เข้าสู่ระบบ
                  </router-link>
                </div> -->
            </div>
        ...
        <div class="absolute inset-x-0 top-0 hidden p-2 transition origin-top transform md:hidden">
            <div class="overflow-hidden bg-white rounded-lg shadow-md ring-1 ring-black ring-opacity-5">
              <div class="flex items-center justify-between px-5 pt-4">
                <div>
                  <img class="w-auto h-8" src="@/assets/img/logo-main.webp" alt="Achieve your life dream" width="160" height="69">
                </div>
                <div class="-mr-2">
